...
const MarqueeLink = () => {
  return (
    <Link to="/contact">
      <div className="rfm-marquee-container cursor-pointer rounded-full border border-transparent bg-white p-2 text-neutral-900 transition-transform hover:scale-105 hover:border hover:border-neutral-300 active:scale-95">
        <div
