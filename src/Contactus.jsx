  ...
  return (
    <main className="overflow-x-hidden p-4">
      ...
      <div className="receptacle mt-5 size-full max-w-7xl mx-auto overflow-hidden md:mt-10 md:w-2/3 md:py-0 xl:w-2/5">
        ...
        <a
          class="flex w-full cursor-pointer flex-col space-y-5 rounded-xl border border-neutral-300 bg-white bg-gradient-to-tr px-6 py-5 transition-all duration-300 hover:scale-[101%] hover:shadow-sm"
          href="https://cal.com/dhananjayshahane/30min"
          target="_blank"
        >
          <div class="flex items-start justify-between gap-5">
            <div class="space-y-0.5">
              <h3 class="text-start font-epilogue font-bold text-neutral-900 md:text-xl">
            ...
            <div class="rounded-full border-2 border-neutral-400 p-3">
              <svg
                stroke="currentColor"
                fill="currentColor"
                stroke-width="0"
          ...
          <div class="flex items-center justify-between gap-5 md:justify-normal">
            ...
            <div class="flex items-center gap-2">
              ...
              <p class="text-base">Google Meet</p>
            </div>
          </div>
        </a>
